...
import 'package:supy_io_test/libraries/init_app/logs/app_bloc_observer.dart';
...
class InitApp {
  ...
  static Future<void> _initAppConfig(AppConfig appConfig) async {
    ...
    if (appConfig.enableBlocObserver) {
      _initBlocObserver(appConfig.blocObserver);
    }
  ...
  static void _initBlocObserver(BlocObserver? blocObserver) {
    Bloc.observer = blocObserver ?? DefaultBlocObserver();
  }
