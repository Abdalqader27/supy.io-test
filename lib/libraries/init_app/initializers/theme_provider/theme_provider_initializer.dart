...
typedef WidgetThemeBuilder = Widget Function(
    BuildContext context, ThemeData theme);

class ThemeProviderInitializer extends StatelessWidget {
  ///This widgets built over [ThemeProvider] and  FlutterScreenUtils
  /// to set app theme and build responsive text styles and other responsive widgets
  /// Refer to [_buildResponsiveTheme]
  const ThemeProviderInitializer(
      {Key? key, required this.builder, required this.themeProviderConfig})
      : super(key: key);
  ...
  _onInit(ThemeController controller,
    ...
    if (savedTheme != null) {
      ...
      if (defaultTheme != null) {
        ...
        controller.setTheme(
            _getBrightnessTheme(platformBrightness ?? Brightness.light));
      }
